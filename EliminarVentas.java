...
public class EliminarVentas {
    ...
    public EliminarVentas() {
        ...
        JLabel titleLabel = new JLabel("Nombre del Titulo:");
    ...
    private void removeProperty() {
        ...
        if (titleToRemove.isEmpty()) {
            JOptionPane.showMessageDialog(frame, "Introduce una propiedad", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (matcher.find()) {
                ...
                JOptionPane.showMessageDialog(frame, "Propiedad eliminada.", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(frame, "Propiedad no encontrada.", "Error", JOptionPane.ERROR_MESSAGE);
            }
            
            titleField.setText("");
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(frame, "Archivo no encontrado, Llama a Ale.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
